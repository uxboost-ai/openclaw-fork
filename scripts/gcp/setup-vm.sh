...
echo ""
echo "  Install skills (binary tools for all 50 skills):"
echo "    bash $REPO_DIR/scripts/gcp/install-skills.sh"
echo "    OPENAI_API_KEY=sk-... bash $REPO_DIR/scripts/gcp/install-skills.sh  # with OpenAI"
echo ""
echo "  Gateway token: $GATEWAY_TOKEN"
